if(!window.esriBundle){
     ...
     Please add the following tag to your index.html file: 
...
const GeographicTransformationStep =
  window.esriBundle.GeographicTransformationStep;
...
const PointCloudClassBreaksRenderer =
  window.esriBundle.PointCloudClassBreaksRenderer;
...
const PointCloudUniqueValueRenderer =
  window.esriBundle.PointCloudUniqueValueRenderer;
...
const ImageServiceIdentifyParameters =
  window.esriBundle.ImageServiceIdentifyParameters;
